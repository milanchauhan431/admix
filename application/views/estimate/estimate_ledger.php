                    ...
                    <div class="card-header">
                        <div class="row">
							...
							<div class="col-md-4 text-center">   
                                <h4 class="card-title pageHeader">Estimate Ledger</h4>                                
                            </div>     
                            <div class="col-md-4">  
...
function loadData(pdf=""){
	...
	if(valid){
		if(pdf == ""){
			$.ajax({
				url: base_url + controller + '/getLedger',
				data: postData,
				type: "POST",
				dataType:'json',
			...
			var url = base_url + controller + '/getLedger/' + encodeURIComponent(window.btoa(JSON.stringify(postData)));
			window.open(url);
		}

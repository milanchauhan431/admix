        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form autocomplete="off" id="saveEstimate" data-res_function="resEstimate" enctype="multipart/form-data">
                            <div class="col-md-12">
                                <div class="row">
                                    ...
                                    <div class="col-md-3 form-group">
                                        ...
                                        <select name="gstin" id="gst_no" class="form-control select2">
                                    ...
                                    <div class="col-md-2 form-group">
										...
										<select name="sales_type" id="sales_type1" class="form-control">
                    ...
                    <div class="card-footer">
                        <div class="col-md-12">
                            <button type="button" class="btn waves-effect waves-light btn-outline-success float-right save-form" onclick="customStore({'formId':'saveEstimate'});" ><i class="fa fa-check"></i> Save</button>
...
<script src="<?php echo base_url(); ?>assets/js/custom/estimate-form.js?v=<?= time() ?>"></script>
